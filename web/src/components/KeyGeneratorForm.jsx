      ...
      <Card className="w-full max-w-4xl mx-auto">
        <CardHeader className="space-y-3">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <CardTitle className="text-lg sm:text-xl">RSA Key Pair Generator</CardTitle>
        ...
        {keys && (
          <CardContent className="space-y-4 sm:space-y-6">
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
                <div className="flex items-center gap-2">
                  ...
                  <Label className="text-sm sm:text-base">Public Key</Label>
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
                <div className="flex items-center gap-2">
                  ...
                  <Label className="text-sm sm:text-base">Private Key</Label>
            ...
            >
              <h5 className="font-semibold text-gray-900 dark:text-gray-100 mb-3 flex items-center gap-2 text-sm sm:text-base">
                📚 Quick Start Guide
              </h5>
              <ol className="text-xs sm:text-sm text-gray-700 dark:text-gray-300 space-y-2 list-decimal list-inside">
